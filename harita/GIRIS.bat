@echo off
chcp 65001 >nul
title USTAD GOZCU - giris ekrani
cd /d "%~dp0"

echo.
echo   ==================================================
echo       U S T A D   G O Z C U     ~~~ o ~~~
echo            G I R I S   E K R A N I
echo   ==================================================
echo.
echo   Bu kisayol GIRIS EKRANINI acar (kure, serit, baslik).
echo   Haritayi acmak icin:  HARITA.bat
echo.
...
echo   Sunucu zaten calisiyor, giris ekrani aciliyor.
start "" "http://127.0.0.1:8811/giris.html"
exit /b 0
